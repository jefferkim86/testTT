<?php /* Smarty version Smarty-3.0.6, created on 2014-08-20 21:23:35
         compiled from "tplv2/pm_index.html" */ ?>
<?php /*%%SmartyHeaderCode:148686660653f4a157eb47e1-45400740%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '148686660653f4a157eb47e1-45400740',
  'function' => 
  array (
  ),
...
<div id="index" class="clearfix">
    <div id="article">
    	...
    	<div class="pm">
			...
			<div id="J-pagination" style="margin-top:20px;width:450px;"></div>
    	</div>
...
<script type="text/template" id="J-followList">
 ...
 <div class="follow_list ${last}" id="myfollow_${id}">
  <div class="follow_con clearfix">
	 <div class="avatar">	       
	  <a href="${replyUrl}" title="">
		 	<img src="${h_img}" alt="" title=""/>
	   </a>
	 </div>	
	 <div class="userinfo">
		<li class="title">
			<a href="${replyUrl}">${tousername}</a> 
			{@if isNew}<span class="not-read"></span>{@/if}
		</li>
		<li class="userdata"><a href="${replyUrl}">${info}</a></li>
	 </div>
	 <div class="oper">
